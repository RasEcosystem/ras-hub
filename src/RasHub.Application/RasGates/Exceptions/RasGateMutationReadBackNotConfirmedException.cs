...
public sealed class RasGateMutationReadBackNotConfirmedException
    : NonRetryableBackgroundTaskException
{
    public RasGateMutationReadBackNotConfirmedException(
        Guid rasGateId,
        string resource,
        string operation,
        Guid externalId,
        ...
        Guid externalId)
    {
        ...
        return $"RasGate '{rasGateId}' confirmed '{resource}.{operation}', " +
               $"but read-back of '{resource}/{externalId}' could not be confirmed.";
    }
}
