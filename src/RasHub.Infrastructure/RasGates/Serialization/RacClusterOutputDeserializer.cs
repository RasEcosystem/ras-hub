...
public sealed class RacClusterOutputDeserializer(
    ...
    : IRacOutputDeserializer<IReadOnlyList<RasClusterSnapshot>>
{
    ...
    private static RasClusterSnapshot DeserializeRecord(RacKeyValueRecord record)
    {
        ...
        return new RasClusterSnapshot
        {
            ...
            RestartSchedule = Unquote(GetOptionalValue(record, "restart-schedule"))
        };
    }
    ...
    {
        return record.Values.ContainsKey(key) && ParseBoolean(record, key);
    }
