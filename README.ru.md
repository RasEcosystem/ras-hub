...
- сохранение состояния RasGate, кластеров, информационных баз и статусов;
...
Чтение shadow state не обращается к RasGate. Удалённые результаты публикуются
только после проверки и при актуальной ревизии конфигурации RasGate.
...
Для удалённого управления также нужен RasGate с сетевым доступом к совместимым
RAC и RAS.
